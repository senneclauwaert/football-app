...
def seed() -> None:
    ...
    try:
        ...
        comp_a = Competition(
            name="Nationale 3 Afd. A",
            type=CompetitionType.league,
            season_id=season.id,
            rbfa_series_id="NAT3A-2425",
        )
        comp_b = Competition(
            name="Provinciale 1 Brabant",
            type=CompetitionType.league,
            season_id=season.id,
            rbfa_series_id="PROV1BRA-2425",
        )
        cup_a = Competition(
            name="Provinciale Beker",
            type=CompetitionType.cup,
            season_id=season.id,
            rbfa_series_id="CUPBRA-2425",
        )
        ...
        for jersey, first, last, pos, dob in first_team_players_data:
            p = Player(
                ...
                appearances=18,
                goals=3 if pos == PlayerPosition.forward else 0,
            )
            db.add(p)
            db.flush()
            players.append(p)
        ...
        matches: list[Match] = []
        for i, (opp, is_home, home_sc, away_sc, status, day_offset) in enumerate(
            all_match_data, 1
        ):
            m = Match(
        ...
        for match in finished[:3]:
            db.add(
                MatchEvent(
                    ...
                    minute=23,
                    player_id=scorer.id,
                    player_name=f"{scorer.first_name} {scorer.last_name}",
                    is_our_team=True,
                )
            )
            db.add(
                MatchEvent(
                    ...
                    minute=55,
                    player_id=yc_player.id,
                    player_name=f"{yc_player.first_name} {yc_player.last_name}",
                    is_our_team=True,
                )
            )
        db.commit()
        ...
        shop_items = [
            ShopItem(
                name="Thuisshirt 2024-2025",
                description="Officieel thuisshirt oranje/zwart.",
                price=Decimal("59.99"),
                category="shirt",
                sizes=["S", "M", "L", "XL", "XXL"],
                stock_quantity=50,
                is_available=True,
                sort_order=1,
                color_label="Oranje/Zwart",
            ),
            ShopItem(
                name="Uitshirt 2024-2025",
                description="Officieel uitshirt wit/zwart.",
                price=Decimal("59.99"),
                category="shirt",
                sizes=["S", "M", "L", "XL"],
                stock_quantity=35,
                is_available=True,
                sort_order=2,
                color_label="Wit/Zwart",
            ),
            ShopItem(
                name="Clubsjaal",
                description="Warme clubsjaal met clubkleuren.",
                price=Decimal("19.99"),
                category="scarf",
                sizes=None,
                stock_quantity=100,
            ...
            ShopItem(
                name="Trainingsjack",
                description="Lichtgewicht trainingsjack.",
                price=Decimal("49.99"),
                category="jacket",
                sizes=["S", "M", "L", "XL", "XXL"],
                stock_quantity=20,
            ...
            ShopItem(
                name="Snapback Cap",
                description="Snapback cap met borduursel.",
                price=Decimal("24.99"),
                category="cap",
                sizes=None,
                stock_quantity=60,
            ...
            ShopItem(
                name="Kindershirt 2024-2025",
                description="Thuisshirt voor kinderen (maat 116–164).",
                price=Decimal("44.99"),
                category="kids",
                sizes=["116", "128", "140", "152", "164"],
                stock_quantity=30,
                is_available=True,
                sort_order=6,
                color_label="Oranje/Zwart",
        ...
        events = [
            Event(
                title="Jaarlijkse clubavond",
                description="Gezellige avond voor alle leden en supporters.",
                date=datetime(2025, 5, 10, 19, 0, tzinfo=timezone.utc),
                location="Clubhuis Relegem",
                is_published=True,
                event_type="social",
                price=Decimal("0"),
            ),
            Event(
                title="Jeugdtornooi U10-U12",
                description="Zomertornooi voor de jeugd.",
                date=datetime(2025, 6, 14, 9, 0, tzinfo=timezone.utc),
                location="Sportpark Relegem",
                is_published=True,
                event_type="tournament",
                price=Decimal("5"),
            ),
            Event(
                title="Sponsordiner 2025",
                description="Exclusief diner voor sponsors en partners.",
                date=datetime(2025, 4, 26, 18, 30, tzinfo=timezone.utc),
                location="Restaurant De Kroon, Relegem",
                is_published=True,
                event_type="sponsor",
                price=Decimal("45"),
            ),
            Event(
                ...
                description="Feest voor alle kampioenen van dit seizoen.",
        ...
        news = [
            News(
                title="3-0 zege tegen JS Ganshoren!",
                category="match",
            ...
            News(
                title="Nieuwe shirtsponsor voor seizoen 2025-2026",
                category="club",
            ...
            News(
                title="U15 wint provinciale beker",
                category="youth",
            ...
            News(
                title="Inschrijvingen seizoen 2025-2026 open",
                category="club",
