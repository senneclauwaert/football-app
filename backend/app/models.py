from sqlalchemy import (
    Column, Integer, String, Float, Boolean, Numeric,
    ForeignKey, DateTime, Date, Enum, Text, Index, JSON
)
...
class Standing(Base):
    ...
    __table_args__ = (
        Index("ix_standings_comp_season", "competition_id", "season_id"),
    )
...
class OrderItem(Base):
    ...
    shop_item_id = Column(Integer, ForeignKey("shop_items.id"), nullable=False, index=True)
