...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("admin", "premium", "normal", name="userrole"),
            nullable=False,
        ),
        sa.Column("is_active", sa.Boolean(), nullable=True),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "backordered", "discontinued", name="itemstatus"),
            nullable=True,
        ),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        op.f("ix_items_expiration_date"), "items", ["expiration_date"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_order_items_item_id"), "order_items", ["item_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum(
                "incoming", "outgoing", "transfer", "adjustment", name="movementtype"
            ),
            nullable=False,
        ),
        sa.Column("quantity", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_stock_movements_type"), "stock_movements", ["type"], unique=False
    )
