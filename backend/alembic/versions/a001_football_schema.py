...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("age_group",    sa.Enum(
            "first_team","reserves","u17","u16","u15","u13","u12","u11","u10","u9","u8","u7","u6",
            name="agegroup"
        ), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("position",       sa.Enum("goalkeeper","defender","midfielder","forward", name="playerposition")),
    ...
    op.create_table(
        ...
        sa.Column("id",               sa.Integer(),   primary_key=True),
        sa.Column("name",             sa.String(255), nullable=False),
        sa.Column("type",             sa.Enum("league","cup","friendly", name="competitiontype"),
    ...
    op.create_index("ix_competitions_rbfa_series_id", "competitions", ["rbfa_series_id"])
    ...
    op.create_table(
        ...
        sa.Column("type",        sa.Enum(
            "goal","own_goal","penalty","yellow_card","red_card","second_yellow","sub_in","sub_out",
            name="matcheventtype"
        ), nullable=False),
    ...
    op.create_index("ix_standings_comp_season", "standings", ["competition_id", "season_id"])
    ...
    op.create_table(
        ...
        sa.Column("category",       sa.Enum("shirt","scarf","hat","other", name="shopcategory"),
    ...
    op.create_table(
        ...
        sa.Column("status",            sa.Enum("pending","paid","shipped","delivered","cancelled",
                                               name="orderstatus"),
    ...
    op.create_table(
        ...
        sa.Column("status",            sa.Enum("running","success","error", name="scraperstatus"),
...
def downgrade() -> None:
    ...
    op.drop_table("users")
    # Drop enums
    for enum_name in ["userrole","agegroup","playerposition","competitiontype",
                      "matchstatus","matcheventtype","orderstatus","shopcategory","scraperstatus"]:
